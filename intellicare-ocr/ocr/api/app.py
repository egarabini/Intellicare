"""FastAPI app para intellicare-ocr."""
...
from ocr.storage.chroma_store import build_chroma_store, set_chroma_store
from ocr.utils.file_utils import normalize_file_type
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="IntelliCare OCR (MINERVA)", version=config.module_version)
