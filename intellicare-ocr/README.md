...
Modulo OCR do IntelliCare (MINERVA).
...
- OCR com visao Llama4 para imagem, com fallback automatico para Surya
...
- Upload com limite por `OCR_MAX_FILE_SIZE_MB`
...
- Vision hardening:
  - timeout configuravel (`OCR_VISION_TIMEOUT_SECONDS`)
