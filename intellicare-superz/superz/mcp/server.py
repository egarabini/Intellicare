"""SuperZMCPServer — MCP Server com 6 tools de inteligencia externa."""
...
from superz.integrations.knowledge_client import KnowledgeClient
from superz.llm.qwen_client import QwenClient
from superz.llm.url_fetcher import URLFetcher
from superz.mcp.schemas import (
    ANALYZE_TEXT_SCHEMA,
...
from superz.mcp.tools.analyze_text import handle_analyze_text
from superz.mcp.tools.check_regulatory import handle_check_regulatory
from superz.mcp.tools.search_medical_literature import handle_search_medical_literature
from superz.mcp.tools.summarize_document import handle_summarize_document
from superz.mcp.tools.translate_to_portuguese import handle_translate_to_portuguese
from superz.mcp.tools.web_search import handle_web_search
...
from superz.search.regulatory_client import RegulatoryClient
...
class SuperZMCPServer:
    """
    MCP Server para intellicare-superz.
    Expoe 6 tools via protocolo MCP sobre HTTP SSE.
    """

    def __init__(self, config: SuperZConfig):
        self._config = config
        self._server = Server("intellicare-superz")
