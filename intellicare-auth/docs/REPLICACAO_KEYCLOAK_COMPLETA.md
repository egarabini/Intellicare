...
```bash
# intellicare-core
cd C:\DOCSHARE\INTELLICARE\intellicare-core
python teste_simples.py

# intellicare-wanda
cd C:\DOCSHARE\INTELLICARE\intellicare-wanda
python teste_simples.py
...
# intellicare-oswaldo
cd C:\DOCSHARE\INTELLICARE\intellicare-oswaldo
python teste_simples.py

# intellicare-zilda
cd C:\DOCSHARE\INTELLICARE\intellicare-zilda
python teste_simples.py

# intellicare-geralda
cd C:\DOCSHARE\INTELLICARE\intellicare-geralda
python teste_simples.py

# intellicare-comunicacao
cd C:\DOCSHARE\INTELLICARE\intellicare-comunicacao
python teste_simples.py
```
