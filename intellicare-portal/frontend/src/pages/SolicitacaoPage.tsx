                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-2 space-y-1 text-sm text-green-800">
                          ...
                          <p>Localização: {cnesData.municipio}{cnesData.uf ? ` - ${cnesData.uf}` : ''}</p>
                ...
                <Card>
                  ...
                  <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input value={`${cnesData.municipio}${cnesData.uf ? ` - ${cnesData.uf}` : ''}`} disabled className="bg-neutral-100" />
                    </div>
                    {cnesData.regiao && (
                      <div>
                        <Label>Região</Label>
                        <Input value={cnesData.regiao} disabled className="bg-neutral-100" />
                      </div>
                    )}
                    {cnesData.endereco && (
                      <div className="md:col-span-2">
