...
- `./intellicare-wanda/DEVLOG.md` — diário detalhado de cada fase
- `./intellicare-wanda/README.md` — instruções de uso e integração
- `apresentacao/wanda_ai/` — implementações dos gravadores, memória, avaliação
- `./intellicare-wanda/fhir_specs_server.py` — servidor de specs FHIR
