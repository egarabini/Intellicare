#!/usr/bin/env python3
"""
Teste simples de integração Keycloak para intellicare-florence
...
CLIENT_SECRET = "ajjWcAieWJoN9HPYulExgdMsjnRb5N1R"
TEST_USER = "dr.silva@saudeplanner.com.br"
TEST_PASSWORD = "Test@123"

def main():
    print("=" * 80)
    print(f"🧪 TESTE SIMPLES - INTEGRAÇÃO KEYCLOAK - INTELLICARE-FLORENCE")
    print("=" * 80)
    print()
