#!/usr/bin/env python3
"""
Teste simples de integração Keycloak para intellicare-core
...
CLIENT_SECRET = "G2iKBiLllozGEJR0Y2ZhwnSzAOZqF9fB"
TEST_USER = "dr.silva@saudeplanner.com.br"
TEST_PASSWORD = "Test@123"

def main():
    print("=" * 80)
    print(f"🧪 TESTE SIMPLES - INTEGRAÇÃO KEYCLOAK - INTELLICARE-CORE")
    print("=" * 80)
    print()
