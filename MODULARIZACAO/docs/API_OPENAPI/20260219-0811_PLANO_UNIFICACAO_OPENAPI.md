...
3. Salvar em pasta central:
   - `MODULARIZACAO/docs/openapi/<modulo>.openapi.json`
...
2. Publicar este índice no repositório:
   - `MODULARIZACAO/docs/API_PORTAL.md`
...
- `MODULARIZACAO/docs/API_CATALOG.md` (inventário atual por rota)
- `MODULARIZACAO/docs/API_PORTAL.md` (links de acesso por ambiente)
- `MODULARIZACAO/docs/openapi/*.openapi.json` (snapshots de specs)
- `MODULARIZACAO/docs/API_CHANGELOG.md` (histórico de mudanças)

## Entregáveis imediatos (já disponíveis)

- Inventário por rota: `MODULARIZACAO/docs/API_CATALOG.md`
- Base em CSV:
