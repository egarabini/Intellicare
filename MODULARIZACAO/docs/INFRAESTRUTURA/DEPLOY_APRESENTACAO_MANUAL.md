...
Crie o arquivo `/opt/intellicare/intellicare/MODULARIZACAO/intellicare-apresentacao/docker-compose.yml` com o seguinte conteúdo:
...
```bash
cd /opt/intellicare/intellicare/MODULARIZACAO/intellicare-apresentacao
docker-compose up -d
```
