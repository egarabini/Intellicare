...
**Localização:** `MODULARIZACAO/.env.example`
...
**Localização:** `MODULARIZACAO/docker-compose.full.yml`
...
**Localização:** `MODULARIZACAO/scripts/smoke_tests.py`
...
**Localização:** `MODULARIZACAO/docs/PLANNER-CURSOR/GUIA_DEPLOY.md`
