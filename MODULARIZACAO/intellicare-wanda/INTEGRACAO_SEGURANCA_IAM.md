...
## Referências
- `MODULARIZACAO/intellicare-auth/` — biblioteca e scripts de setup
- `MODULARIZACAO/intellicare-donabedian/` — piloto de integração
- `MODULARIZACAO/intellicare-wanda/` — integração prioritária
