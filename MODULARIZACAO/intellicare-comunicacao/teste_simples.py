#!/usr/bin/env python3
"""
Teste simples de integração Keycloak para intellicare-comunicacao
...
CLIENT_SECRET = "ZLF3w2SuQsJ8YxgCnitKRXYEqvThynTo"
TEST_USER = "dr.silva@saudeplanner.com.br"
TEST_PASSWORD = "Test@123"

def main():
    print("=" * 80)
    print(f"🧪 TESTE SIMPLES - INTEGRAÇÃO KEYCLOAK - INTELLICARE-COMUNICACAO")
    print("=" * 80)
    print()
