...
scp -r MODULARIZACAO/intellicare-comunicacao usuario@IP_SERVIDOR:/home/usuario/

# Ou com porta customizada
scp -P PORTA -r MODULARIZACAO/intellicare-comunicacao usuario@IP_SERVIDOR:/home/usuario/
```
...
cd INTELLICARE/MODULARIZACAO/intellicare-comunicacao
```
