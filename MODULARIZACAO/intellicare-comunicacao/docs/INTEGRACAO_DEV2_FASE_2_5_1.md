...
graph TD
    ...
    C -->|"03_ESPECIFICACAO_TECNICA_*.md<br/>Schemas SQLAlchemy"| D["📋 ENTRADA FASE 2.5.1<br/>(MODULARIZACAO/)"]
...
cd C:\DOCSHARE\INTELLICARE\MODULARIZACAO\intellicare-florence\docs/
