"""
Comprehensive test of all CRUD endpoints for Oswaldo - Fixed unicode.
"""
...
try:
    ...
    print(f"   [OK] Status: {response.status_code} - Condition created with ID: {condicao_id}\n")
    ...
    print(f"   [OK] Status: {response.status_code} - Retrieved: {response.json()['cid10']}\n")
    ...
    print(f"   [OK] Status: {response.status_code} - Total conditions: {result['total']}\n")
    ...
    assert response.status_code == 200
    print(f"   [OK] Status: {response.status_code} - Updated status: {response.json()['status']}\n")
    ...
    print(f"   [OK] Status: {response.status_code} - Follow-up created with ID: {acomp_id}\n")
    ...
    assert response.status_code == 200
    result = response.json()
    print(f"   [OK] Status: {response.status_code} - Total follow-ups: {result['total']}\n")
    ...
    assert response.status_code == 200
    print(f"   [OK] Status: {response.status_code} - Follow-up retrieved\n")
    ...
    print(f"   [OK] Status: {response.status_code} - Invalid transition correctly rejected\n")
    ...
    assert response.status_code == 200
    print(f"   [OK] Status: {response.status_code} - Condition soft-deleted\n")
    ...
    print(f"   [OK] Status: {response.status_code} - Condition status is now: {status}\n")

    print("=" * 70)
    print("SUCCESS! ALL 14 ENDPOINT TESTS PASSED!")
    print("=" * 70)
    print("\nEndpoints Tested:")
    print("  [OK] POST   /api/v1/oswaldo/condicoes")
    print("  [OK] GET    /api/v1/oswaldo/condicoes/{id}")
    print("  [OK] GET    /api/v1/oswaldo/paciente/{cpf}/condicoes")
    print("  [OK] PUT    /api/v1/oswaldo/condicoes/{id}")
    print("  [OK] DELETE /api/v1/oswaldo/condicoes/{id}")
    print("  [OK] POST   /api/v1/oswaldo/acompanhamentos")
    print("  [OK] GET    /api/v1/oswaldo/acompanhamentos/{id}")
    print("  [OK] GET    /api/v1/oswaldo/paciente/{cpf}/acompanhamentos")
    print("  [OK] GET    /api/v1/oswaldo/paciente/{cpf}/timeline")
    print("  [OK] GET    /api/v1/oswaldo/alertas/pendentes")
    print("  [OK] GET    /api/v1/oswaldo/alertas/resumo")
    print("=" * 70)
