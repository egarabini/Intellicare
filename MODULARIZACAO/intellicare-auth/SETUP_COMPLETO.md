...
- **Realm**: bemcuidar
- **Documentação**: `MODULARIZACAO/intellicare-auth/docs/`
- **Quick Start**: `MODULARIZACAO/intellicare-auth/QUICK_START.md`
- **Status**: `MODULARIZACAO/intellicare-auth/STATUS.md`
