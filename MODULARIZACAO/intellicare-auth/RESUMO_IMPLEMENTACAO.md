...
- `MODULARIZACAO/intellicare-donabedian/src/donabedian/api/main.py`
- `MODULARIZACAO/intellicare-donabedian/src/donabedian/api/routes/*.py`
- `MODULARIZACAO/intellicare-donabedian/.env`
