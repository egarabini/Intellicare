...
log_info "B2. Navegando para MODULARIZACAO..."
if [ -d "MODULARIZACAO" ]; then
    cd MODULARIZACAO
    log_info "✅ Diretório MODULARIZACAO encontrado"
else
    log_error "Diretório MODULARIZACAO não encontrado!"
    exit 1
fi
