...
grep -c "apresentacao:" /opt/intellicare/intellicare/MODULARIZACAO/traefik/dynamic/routes-intellicare.yml || echo "NOT FOUND"
...
docker run -d \
  ...
  -v /opt/intellicare/intellicare/MODULARIZACAO/intellicare-apresentacao/apresentacao/web:/usr/share/nginx/html:ro \
