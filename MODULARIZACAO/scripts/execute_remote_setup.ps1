...
Invoke-SSHCommand -Command "ls -la /opt/intellicare/intellicare/MODULARIZACAO" -Description "B2 Verificando diretório MODULARIZACAO"

# B3. Configurar .env
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && cp .env.homologacao .env" -Description "B3.1 Copiando .env.homologacao para .env"
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && head -n 10 .env" -Description "B3.2 Verificando .env (primeiras 10 linhas)"
...
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker-compose -f docker-compose.full.yml up -d postgres redis" -Description "C1 Subindo PostgreSQL e Redis"

# C2. Aguardar e validar
Write-Host "[INFO] Aguardando serviços iniciarem (30 segundos)..." -ForegroundColor Green
Start-Sleep -Seconds 30

Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker-compose -f docker-compose.full.yml ps" -Description "C2.1 Verificando status dos containers"
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker-compose -f docker-compose.full.yml logs --tail=20 postgres" -Description "C2.2 Logs do PostgreSQL"
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker-compose -f docker-compose.full.yml logs --tail=20 redis" -Description "C2.3 Logs do Redis"
...
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker exec -i `$(docker-compose -f docker-compose.full.yml ps -q postgres) psql -U intellicare_admin -d intellicare_db -c 'CREATE SCHEMA IF NOT EXISTS intellicare_florence;'" -Description "C3.1 Criando schema intellicare_florence"
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker exec -i `$(docker-compose -f docker-compose.full.yml ps -q postgres) psql -U intellicare_admin -d intellicare_db -c 'CREATE SCHEMA IF NOT EXISTS intellicare_oswaldo;'" -Description "C3.2 Criando schema intellicare_oswaldo"
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker exec -i `$(docker-compose -f docker-compose.full.yml ps -q postgres) psql -U intellicare_admin -d intellicare_db -c 'CREATE SCHEMA IF NOT EXISTS intellicare_donabedian;'" -Description "C3.3 Criando schema intellicare_donabedian"
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker exec -i `$(docker-compose -f docker-compose.full.yml ps -q postgres) psql -U intellicare_admin -d intellicare_db -c 'CREATE SCHEMA IF NOT EXISTS intellicare_wanda;'" -Description "C3.4 Criando schema intellicare_wanda"
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker exec -i `$(docker-compose -f docker-compose.full.yml ps -q postgres) psql -U intellicare_admin -d intellicare_db -c 'CREATE SCHEMA IF NOT EXISTS intellicare_comunicacao;'" -Description "C3.5 Criando schema intellicare_comunicacao"
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker exec -i `$(docker-compose -f docker-compose.full.yml ps -q postgres) psql -U intellicare_admin -d intellicare_db -c 'CREATE SCHEMA IF NOT EXISTS intellicare_geralda;'" -Description "C3.6 Criando schema intellicare_geralda"
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker exec -i `$(docker-compose -f docker-compose.full.yml ps -q postgres) psql -U intellicare_admin -d intellicare_db -c '\dn'" -Description "C3.7 Listando schemas criados"
...
Invoke-SSHCommand -Command "cd /opt/intellicare/intellicare/MODULARIZACAO && docker-compose -f docker-compose.full.yml ps" -Description "Status final dos containers"
