...
scp MODULARIZACAO\scripts\fix_apresentacao.sh ${SERVER}:/tmp/

# 2. Upload Traefik config
Write-Host "`n📤 Uploading Traefik configuration..." -ForegroundColor Yellow
scp MODULARIZACAO\traefik\dynamic\routes-intellicare.yml ${SERVER}:/opt/intellicare/intellicare/MODULARIZACAO/traefik/dynamic/
