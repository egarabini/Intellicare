#!/usr/bin/env python3
"""
Teste simples de integração Keycloak para intellicare-zilda
...
CLIENT_SECRET = "VmS5niVQNxNF1gzO83gjbQdqwH13tly3"
TEST_USER = "dr.silva@saudeplanner.com.br"
TEST_PASSWORD = "Test@123"

def main():
    print("=" * 80)
    print(f"🧪 TESTE SIMPLES - INTEGRAÇÃO KEYCLOAK - INTELLICARE-ZILDA")
    print("=" * 80)
    print()
