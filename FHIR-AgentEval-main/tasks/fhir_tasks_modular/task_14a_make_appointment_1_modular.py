# task_14a_make_appointment_1_modular.py
...
class MakeAppointmentTaskModular(TaskInterfaceModular):
    ...
    def get_prompt(self) -> str:
        ...
        return f"""
Make an appointment time for the patient {' '.join(patient_given)} {patient_family} with Provider Dr. {' '.join(practitioner_given)} {practitioner_family} on next {target_day} morning at {target_hour}:00."
...
"""
    ...
    def execute_human_agent(self) -> ExecutionResult:
        ...
        # if today is the target day, we should advance to next week?
        params = {
