#!/usr/bin/env python3
"""
Teste simples de integração Keycloak para intellicare-oswaldo
...
CLIENT_SECRET = "hJMNZx2bhF1Wfqh31cpGwuphF7W2E340"
TEST_USER = "dr.silva@saudeplanner.com.br"
TEST_PASSWORD = "Test@123"

def main():
    print("=" * 80)
    print(f"🧪 TESTE SIMPLES - INTEGRAÇÃO KEYCLOAK - INTELLICARE-OSWALDO")
    print("=" * 80)
    print()
