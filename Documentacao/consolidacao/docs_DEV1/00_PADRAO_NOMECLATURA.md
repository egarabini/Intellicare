...
02_SEPARACAO_DADOS_TESTE.md
02_SEPARACAO_DADOS_DEPLOY.md
02_SEPARACAO_DADOS_ROLLBACK.md
```
...
2. **Usar underscore (_) como separador**
   ```
   ✅ 01_KEYCLOAK_INTEGRACAO_FUNCIONAL.md
   ❌ 01-KEYCLOAK-INTEGRACAO-FUNCIONAL.md
   ❌ 01.KEYCLOAK.INTEGRACAO.FUNCIONAL.md
   ```
...
4. **Ser descritivo mas conciso**
   ```
   ✅ 01_KEYCLOAK_INTEGRACAO_FUNCIONAL.md
   ❌ 01_INTEGRACAO_COMPLETA_DO_KEYCLOAK_COM_TODOS_OS_MODULOS_FUNCIONAL.md
   ```
...
2. **Não usar acentos ou caracteres especiais**
   ```
   ❌ 01_INTEGRAÇÃO_KEYCLOAK_FUNCIONAL.md
   ❌ 01_KEYCLOAK_INTEGRAÇÃO_FUNCIONAL.md
   ```
...
5. **Não omitir a sequência**
   ```
   ❌ KEYCLOAK_INTEGRACAO_FUNCIONAL.md
   ✅ 01_KEYCLOAK_INTEGRACAO_FUNCIONAL.md
   ```
