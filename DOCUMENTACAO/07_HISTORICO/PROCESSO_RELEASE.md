# Processo de Release — IntelliCare .
...
Este documento define o processo passo a passo para criar releases no projeto IntelliCare .. Qualquer desenvolvedor deve conseguir executar um release seguindo este guia sem ambiguidade.
