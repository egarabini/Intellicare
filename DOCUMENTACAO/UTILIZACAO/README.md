...
- cobertura funcional: sprint 2026-05-23 concluída — DEMs 065 a 090 validadas em staging.
- Sprint 2026-05-30 aplicada (DEM-091 — VPS Deploy).
...
- `11_LINHA_DO_TEMPO.md` - visao longitudinal clinica no perfil do paciente.
- `12_RECEITUARIO_DIGITAL.md` - guia de impressao de receituario CFM/ANVISA.
- `13_PROMPTS_IA.md` - gestao e versionamento de prompts no AdminUI.
- `14_RESUMO_EXECUTIVO_SPRINT_2026_04_25.md` - release note executiva para operacao e lideranca.
