...
| Item | Problema | Ação |
|------|----------|------|
| **Path após clone** | SERVIDOR_HOMOLOGACAO_README diz `cd intellicare`; SERVIDOR_HOMOLOGACAO_CONTABO diz `cd intellicare/intellicare` | Verificar estrutura real do repo `eduardo/intellicare`; ajustar documentação conforme o path correto |
