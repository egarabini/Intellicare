...
2. Criar `.env.example` na raiz de .
...
**Entregáveis:**
- `./docker-compose.full.yml` (~300 linhas)
...
**Tarefas:**
1. Criar `./scripts/smoke_tests.py`
...
**Entregáveis:**
- `./scripts/smoke_tests.py` (~200 linhas)
...
**Tarefas:**
1. Criar `./docs/PLANNER-CURSOR/GUIA_DEPLOY.md`
