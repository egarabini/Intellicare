...
- **Arquivo:** `./.env.example` (256 linhas)
- **Conteúdo:**
...
- **Arquivo:** `./docker-compose.full.yml` (481 linhas)
- **Conteúdo:**
...
- **Arquivo:** `./scripts/smoke_tests.py` (285 linhas)
- **Funcionalidades:**
...
- **Arquivo:** `./GUIA_DEPLOY.md` (807 linhas)
- **Seções:**
...
**Evidências:**
- Arquivo criado: `./.env.example` (256 linhas)
...
**Evidências:**
- Arquivo criado: `./docker-compose.full.yml` (481 linhas)
...
grep "VITE_API_" ./intellicare-portal/frontend/.env.example
# Resultado: 6 URLs de backends

# Verificar build args no Dockerfile
grep "ARG VITE_API_" ./intellicare-portal/frontend/Dockerfile
...
**Evidências:**
- Arquivo criado: `./scripts/smoke_tests.py` (285 linhas)
- Verifica 9 serviços:
  - 6 backends (Florence, Oswaldo, Donabedian, Wanda, Comunicacao, Geralda)
  - 1 frontend (Portal)
...
**Evidências:**
- Arquivo criado: `./GUIA_DEPLOY.md` (807 linhas)
- 11 seções completas:
...
grep -A 10 "postgres:" ./docker-compose.full.yml
grep -A 10 "redis:" ./docker-compose.full.yml
