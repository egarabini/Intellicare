...
│   ├── exceptions.py        # AuthenticationError, InvalidTokenError, KeycloakConnectionError
│   ├── tenant_resolver_middleware.py  # Multi-tenant resolver
│   └── smart/               # SMART-on-FHIR implementation
│       ├── scopes.py
│       ├── launch.py
│       └── well_known.py
├── keycloak/
...
```python
# intellicare_core/tenant/resolver.py
