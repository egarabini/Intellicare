...
<!--
  ...
  2. Dev preenche a Seção 3 (Log de Execução) conforme avança.
  3. Ao concluir, avisar Eduardo para revisão (Seção 4).
  4. Claude + Eduardo aprovam e executam PR + deploy (Seção 5).

  NOMENCLATURA DO ARQUIVO:
  YYYYMMDD-HHMM_DEM-NNN_MODULO_DESCRICAO.md

  ONDE SALVAR:
  docs/RELATORIOS_E_ANDAMENTO/DEMANDAS/
-->
...
| **Data início dev** | — |
| **Data conclusão** | — |
| **Spec funcional** | [link para doc de spec](../path/spec.md) |
| **PR** | — |
| **Deploy staging** | — |
