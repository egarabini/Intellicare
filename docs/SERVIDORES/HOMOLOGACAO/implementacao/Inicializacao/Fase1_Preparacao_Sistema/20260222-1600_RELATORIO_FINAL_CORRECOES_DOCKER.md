...
**Solução Aplicada:**
1. ✅ Modificado `./intellicare-donabedian/Dockerfile`:
   ```dockerfile
...
**Solução Aplicada:**
1. ✅ Adicionado ao `./intellicare-oswaldo/pyproject.toml`:
   ```toml
   psycopg = {extras = ["binary"], version = "^3.1.0"}
   ```

2. ✅ Adicionado ao `./intellicare-comunicacao/pyproject.toml`:
   ```toml
   psycopg = {extras = ["binary"], version = "^3.1.0"}
   ```
...
### Código-Fonte
1. `./intellicare-donabedian/Dockerfile`
2. `./intellicare-donabedian/src/donabedian/api/routes/pillars.py`
3. `./intellicare-donabedian/src/donabedian/api/routes/indicators.py`
4. `./intellicare-donabedian/src/donabedian/api/routes/indicator_pillars.py`
5. `./intellicare-donabedian/src/donabedian/api/routes/measurements.py`
6. `./intellicare-donabedian/src/donabedian/api/routes/assessment.py`
7. `./intellicare-donabedian/src/donabedian/api/routes/dashboard.py`
8. `./intellicare-donabedian/src/donabedian/api/routes/trends.py`
9. `./intellicare-oswaldo/pyproject.toml`
10. `./intellicare-comunicacao/pyproject.toml`

### Configuração (Servidor)
11. `/opt/intellicare/intellicare/.env` - URL encoding aplicado
